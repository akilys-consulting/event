export const messages = [
  ...
  { code: "LCER", message: "récupération des commerciaux impossible", type: "error" },
  ...
  { code: "PACM", message: "Votre commande a été prise en compte, merci", type: "succes" },
  { code: 'EGIM', message: 'Impossible de récuperer la banque emplacement', type: 'error' },
  { code: 'LIMG', message: 'Impossible de charger une image', type: 'error' },
  { code: 'LEVT', message: 'Impossible de charger vos évènements', type: 'error' },
  { code: 'EVAD', message: "Impossible de retrouver l'adresse du plan", type: 'warning' },
  { code: 'EVLP', message: "Impossible de retrouver la liste des plans", type: 'error' },
  { code: 'EADC', message: "le nom, la catégorie et la programmation sont obligatoire", type: 'error' },
  {
    code: "SRKO",
  ...
  {
    code: "CCKO",
    message: "Impossible d'enregistrer votre commande, contacter l'administrateur",
    type: "error"
  },
  {
    code: "MSPR",
    message: "La proposition a été envoyée",
    type: "success"
  },
